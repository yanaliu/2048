...
function prepareForMobile() {
	if(documentWidth > 500) {
		gridContinerWidth = 500;
		cellSideLength = 100;
		cellSpace = 20;
	} 
	$("#grid-container").css("width", gridContinerWidth - 2*cellSpace);
	$("#grid-container").css("height", gridContinerWidth - 2*cellSpace);
	$("#grid-container").css("padding", cellSpace);
	$("#grid-container").css("border-radius", 0.02 * gridContinerWidth);
